...
QA-инженер с опытом работы в продуктовом ПО с микросервисной архитектурой. Участвую в полном цикле тестирования: от анализа требований до проверки в продакшене. Работал в команде из 6 человек, активно взаимодействую с разработчиками (фронт/бэк), аналитиками и DevOps. Умею не только находить баги, но и предлагать улучшения процессов. Использую нейросети для оптимизации рутинных задач.

Английский: B2 (читаю техническую документацию, веду переписку).

Дополнительная информация

· Английский язык: B2 (Intermediate) — читаю техническую документацию, веду переписку.

Личные качества: Внимателен к деталям, системно мыслю, умею аргументировать свою позицию в спорах с разработчиками, быстро обучаюсь новым инструментам.
· Хобби: GameDev (понимание специфики тестирования игр), участвую в тестировании pet-проектов друзей.




QA Studio
QA Engineer / Manual / REST API / WEB

Участвовал в тестировании микросервисной архитектуры, включая сервисы оплаты, авторизации, ачивок, покупки аватаров, и PvP битв.
...
· Настроил коллекции в Postman с переменными окружений для быстрого переключения между стендами — ускорил регрессионное тестирование API.
· Использовал WireMock для создания заглушек — позволило тестировать фронт независимо от готовности бэкенда.
· Проверял асинхронные сценарии через Kafka, анализировал трассировку запросов в Jaeger.

Работа с БД и логами

· Писал SQL-запросы средней сложности (join, group by, агрегатные функции) в PostgreSQL, работал с MongoDB.
· Анализировал логи в Kibana, Sentry, Grafana для поиска причин ошибок — сократил время дебага на 20–30%.
...
· Проверял вёрстку и стили по макетам в Figma.
· Проводил кроссбраузерное и кросс-платформенное тестирование через BrowserStack.

Документирование и процессы

· Создавал тест-кейсы и тест-сьюты в Test IT для регрессионного тестирования.
· Оформлял баг-репорты в Яндекс.Трекер (приоритеты, шаги воспроизведения, логи).
· Составлял чек-листы в Miro (MindMap)
· Участвовал в тестировании требований к фичам на этапе аналитики.
...
· Писал простые автотесты на JavaScript для проверки критических сценариев.
· Активно использую GPT и нейросети для автоматизации рутинных задач (генерация тест-данных, написание SQL-запросов).
