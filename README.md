...
- Ежедневная работа в Яндекс Трекер
- Обучение и практика c ментором в группе из 8 учеников
- Клиент-серверная архитектура и принципы работы HTTP/HTTPS
- Опыт работы с Devtools: вкладки Network, Applications, -Свойства Cookie, просмотр Local Storage и Session Storage, Кэш браузера
- Ручное тестирование REST API нескольких микро сервисов
- Работал с документацией в Swagger
- Опыт работы с Postman: запросы, ответы, коллекции, переменные, cUrl
- Простые автотесты на JavaScript
- Работал с WSDL и протоколом SOAP
- Опыт тестирования требований к будущей фиче
- Применение на практике техник тест-дизайна
- Применяю GPT и нейросети, чтобы ускорить решение рутинных задач в тестировании
- Опыт создания с нуля тестовой документации
- Работа с Яндекс.Метрикой для QA: анализ самых популярных браузеров, устройств, ОС
- Использую Miro, как инструмент тестировщика: составляю чек-листы в виде MindMap
[https://miro.com/app/board/uXjVGIHpuDY=/?share_link_id=207625199249]
- Работа с Figma, как с источником документации для QA (проверка вёрстки и стилей)
- Функциональное тестирование авторизации так же есть в Miro(сессии)
[https://miro.com/app/board/uXjVGIHpuDY=/?share_link_id=207625199249]
-Опыт создания тест-кейсов в TMS Test IT и тест-сьютов для регрессивного тестирования
-Создание баг-репортов в таск-трекер Яндекс Трекер
-Работа с логами: Kibana и Sentry
-Работа с Grafana для QA: технические и продуктовые дашборды
-Cоставлял SQL запросы средней сложности: Select, join,group by, агрегатные функции
-Работа с реляционной БД: PostgreSQL и не реляционные БД: MongoDB, Redis
-Применял SQL для тестирования логики фичей: «Покупка Аватара» , «Ачивки»
-Работа с серверным кэшом в БД Redis
-Для интеграционного тестирования использовал просмотр трассировки в Jaeger
-Применял Сниффер Charles для тестирования обработки на клиенте ошибок от сервера и подмены контента
-Тестировал асинхронное взаимодействие микросервисов через брокер сообщений Kafka
-Работа с Git и создание репозитория [https://github.com/DevilS1990/DevilS1990.github.io]
-Опыт работы с Linux: базовые команды и анализ логов на сервере в режиме реального времени ( tail -f)
-Создание сайта визитки: [https://github.com/DevilS1990/Sait]
-Опыт работы с GitLab CI/CD - запускал сборку в PROD и STAGE
-Применял переменные Enviroment в Postman для переключения между окружениями
-Создавал в WireMock заглушки (моки) для тестирования фичи на фронте
-Опыт работы со стеком Atlassian: Jira и Confluence

Стек : Devtools, Postman, REST API, Swagger, Soap UI, gPT, Figma, Miro, Яндекс.Метрика, Test IT, Kibana, Grafana, Sentry, Яндекс Трекер, DBeaver, PostgreSQL, MongoDB, Redis, Jaeger, Metabase, Compass, Charles, Kafka, Git, Linux, Bash, CI/CD, GitLab, GitHub, WireMock, Jira, Confluence
