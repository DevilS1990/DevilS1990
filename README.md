...
· Работал с Git (ветвление), участвовал в CI/CD пайплайнов в GitLab (сборка стендов).

---

МОБИЛЬНОЕ ТЕСТИРОВАНИЕ (базовые знания / изучаю самостоятельно):

· Понимание особенностей iOS и Android платформ (жесты, навигация, разрешения, фоновые режимы, уведомления)

· Работа с Charles для проксирования трафика с мобильного устройства (подмена ответов, тестирование офлайн-режимов)

· Знаком с эмуляторами: Android Studio Emulator, Xcode Simulator (теоретически)

· Понимание различий между нативными, гибридными и веб-приложениями

Готов быстро освоить Appium под задачи проекта.
...
· CI/CD , Linux (команды для просмотра логов)
