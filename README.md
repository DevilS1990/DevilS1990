...
2. Ускорение подготовки тестовых данных: Автоматизировал создание сложных тестовых сценариев через Pre-request Scripts в Postman. Например, реализовал массовое создание покемонов (3 вместо 6 запросов) и их батч-загрузку в покеболлы, что сэкономило до 40% времени на подготовку данных для тестирования PvP-битв.
